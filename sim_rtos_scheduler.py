...
from sim_rtos_constantes import COLOR_FONDO_SCHEDULER,COLOR_LETRA_SCHEDULER
from sim_rtos_constantes import COLOR_BOTON,COLOR_LETRA_BOTON
from sim_rtos_constantes import FONT_LETRA_SCHEDULER,FONT_LETRITA_SCHEDULER
